        ...
        $.widget = (function (orig) {
            return function () {
                ...
                constructor.initSelector =
                    constructor.prototype.initSelector !== undefined ? constructor.prototype.initSelector : ":jqmData(role='" + name + "')";
            ...
            _enhance: function (theElement, myId) {
                var currentOptions = this.options,
                    ...
                    ui = {
                        ...
                        container: $(
                            "<div class='ui-popup-container ui-popup-hidden ui-popup-truncate" + (wrapperClass ? " " + wrapperClass : "") + "'></div>"
                        ),
                    },
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.selectmenu", $.mobile.selectmenu, {
            ...
            build: function () {
                ...
                listbox = $("<div" + themeAttr + overlayThemeAttr + " id='" + popupId + "' class='ui-selectmenu'></div>")
