(function(){
    ...
    var template = ''
        ...
        + '            <span class="arrow" :class="{ \'is-title-only\': !content && !subcontent && !htmlType }" :style="getArrowPosX"></span>'
        + '            <div class="wrap" v-if="!htmlType && !image">'
    ...
    comp = Vue.component( "comp-bubble-box", {
		...
		mounted: function() {
            ...
            if( !this.subject ) this.title = $( this.$slots.default[ 0 ].elm ).text();
        ...
        watch: {
            ...
            subject: function( $val ){
                if( !$val ) this.title = $( this.$slots.default[ 0 ].elm ).text();
                else this.title = $val;
            }
        },
        methods: {
            ...
            set_rePos: function(){
                if( this.pos.indexOf( "T" ) >= 0 ) this.pos_top = $( this.$slots.default[ 0 ].elm ).offset().top - $(window).scrollTop() - parseInt( $( this.$slots.default[ 0 ].elm ).outerHeight() / 2 ) + 3;
                else if( this.pos.indexOf( "B" ) >= 0 ) this.pos_top = $( this.$slots.default[ 0 ].elm ).offset().top - $(window).scrollTop() + $( this.$slots.default[ 0 ].elm ).outerHeight() + parseInt( $( this.$slots.default[ 0 ].elm ).outerHeight() / 2 ) - 3;
