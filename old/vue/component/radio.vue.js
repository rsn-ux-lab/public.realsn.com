(function(){
    ...
    var template = ''
        ...
        + '    <input v-if="click" :id="id" type="radio" :data-grp="grp" :value="val" v-model="checked" :disabled="disabled" @click="evt_click">'
        + '    <input v-else :id="id" type="radio" :data-grp="grp" :value="val" v-model="checked" :disabled="disabled">'
        + '    <label :for="id">'
