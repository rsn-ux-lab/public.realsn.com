(function(){
    ...
    var template = ''
        ...
        + '                            <button v-if="type == \'input\'" class="item" :class="{ \'is-active\' : idx == selectedIdx || selectedItem.code == item.code }" :data-idx="idx" @click="evt_itemClick( $event, item )" :data-data="JSON.stringify( item )">'
        ...
        + '                                </template>'
        + '                            </button>'
        + '                            <button v-else class="item" :class="{ \'is-active\' : idx == selectedIdx || selectedItem.code == item.code }" :data-idx="idx" @click="evt_itemClick( $event, item )" :data-data="JSON.stringify( item )">'
